%A primeira ação a ser realizada consiste em limpar o lixo que a memória possa conter 
...
% A segunda ação é receber a matriz A 
% A matriz A é formada pelos números que multiplicam as incognitas


A = [10 20 10; 50 40 20; 20 10 30]


% A terceira ação é receber a matriz B
% A matriz B é formada pelos resultados das equações  
 
B = [150;450;250]

 
% A quarta ação é encontrar o número de linhas e colunas de A, que, respectivamente indicam a quantidade de equaçôes e incognitas do sistema
[m,n] = size (A);

%A quinta ação é organizar os pivos 
...
% A sexta ação é realizar o escalonamento
...
% A setima ação é simplificar as matrizes
